                        ...
                        <div class="relative w-full mt-10 space-y-8">
                            ...
                            <div class="relative">
                                <div class="font-medium text-gray-900"> <span>Image:</span>
                                    <div class="relative h-32 rounded-lg border-dashed border-2 border-blue-700 bg-gray-100 flex justify-center items-center">
                                        <div class="absolute">
                                        ...
                                        </div> <input type="file" class="h-full w-full opacity-0" name="image_url">
                                    </div>
                                </div>
                            </div>
                            <div class="relative">
